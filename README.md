# Large SMS Display (LSMSD)

This Android project connects to, and controls, two large rectangular LED matrixes.
...
6. **Right-click** the **Large SMS Display** project in your Package Explorer and select 	**Properties**
